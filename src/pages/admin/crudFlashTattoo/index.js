                        ...
                        <div className="tamanho-info">
                            ...
                            <div className="valores-tattoo">
                                <div id="first-inf">
                                    ...
                                    <p></p>
                                    <input className="inputp" type="number" id="tamanhopa" name="tamanhopa" placeholder="R$" />
                                </div>
                                <div id="second-inf">
                                    <button 
                                        className="btn btn-valor"
                                    ...
                                    <p></p>
                                    <input className="inputp" type="number" id="tamanhoma" name="tamanhoma" placeholder="R$" />
                                </div>
                                <div id="third-inf">
                                    <button 
                                        className="btn btn-valor" 
                                    ...
                                    <p></p>
                                    <input className="inputp" type="number" id="tamanhoga" name="tamanhoga" placeholder="R$" />
                                </div>
                            </div>
                        </div>
